...
public:
    ...
    virtual boost::shared_ptr<SignalType> create(boost::asio::io_service* io = NULL)
    {
        ...
        boost::shared_ptr<SignalType> newSig(createNewSignal(sigName, *useIo, typename gens<sizeof...(Args)>::type()));
...
private:
    ...
    std::vector<boost::shared_ptr<SignalType> > _signalList;
